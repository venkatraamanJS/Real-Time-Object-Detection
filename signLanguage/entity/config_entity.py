...
#
#This code defines a class TrainingPipelineConfig using the @dataclass decorator,
#  which allows for easier creation of classes to hold data.
# 
#It includes an attribute artifacts_dir,which represents the directory where artifacts (results or outputs) will be stored,
#  and it initializes it using the os.path.join() function to combine ARTIFACTS_DIR and TIMESTAMP.
